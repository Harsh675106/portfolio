    ...
    >
      ...
      <div className="space-y-6  lg:py-5 relative z-10">
        ...
        <div className="min-h-screen mt-2 space-y-10">
          <div className="min-h-screen mt-2 space-y-10">
            <div className="home-feature-row flex flex-col md:flex-row gap-6">
              {/* Expertise Section */}
              <Reveal
                as="div"
                className={`home-feature-card flex-1 rounded-2xl bg-transparent shadow-none p-0 fx-cream-trans ${shadowHover} hover:scale-[1.03] flex justify-center mt-4 md:mt-6`}
              >
          ...
          <Reveal
            as="div"
            className={`home-location-wrap flex-1 rounded-2xl bg-transparent shadow-none fx-cream-trans ${shadowHover} hover:scale-[1.03]`}
          >
